...
struct Prediction_Copy_Structure
{
	...
	void Construct(void* Destination, void* Source, void* Handler)
	{
		...
		Construct_Type((unsigned __int32)Client_Module + 1813568)(this, 2, Destination, 0, Source, 1, 1, nullptr, nullptr, 1, Handler);
	}
};
...
void Predicton_Copy_Compare(void* Unknown_Parameter_1, void* Unknown_Parameter_2, void* Unknown_Parameter_3, void* Unknown_Parameter_4, void* Unknown_Parameter_5, void* Unknown_Parameter_6, __int8 Within_Tolerance, void* Unknown_Parameter_7)
{
	if (Within_Tolerance == 1)
	{
		...
		Byte_Manager::Copy_Bytes(1, (void*)(*(unsigned __int32*)((unsigned __int32)Client_Module + 7170160) + Compute_Flat_Offset(&Flat_Offsets[Field], Predicton_Copy.Descriptor, Field, 0)), Field->Bytes, (void*)((unsigned __int32)Predicton_Copy.Source + Field->Offset[1]));
	}
}
...
void __thiscall Redirected_Post_Network_Data_Received(void* Unknown_Parameter, __int32 Commands_Acknowledged)
{
	...
	void* Result = *(void**)((unsigned __int32)Local_Player + 1080 + (90 - ((Commands_Acknowledged - 1) % 90 + 1) * 90 % -~90) * 4);
	...
	if (Result != nullptr)
	{
		...
		Transfer_Data_Type((unsigned __int32)Client_Module + 1820160)(&Predicton_Copy, nullptr, -1, (Prediction_Descriptor_Structure*)((unsigned __int32)Client_Module + 6890952));
	}
