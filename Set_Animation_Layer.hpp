void Redirected_Set_Animation_Layer(void* Proxy, Animation_Layer_Structure* Animation_Layer)
{
	...
	if ((Animation_Layer->Owner != nullptr) * (Animation_Layer->Owner == *(void**)((unsigned __int32)Client_Module + 7170160)) == 1)
	{
		*(void**)((unsigned __int32)Animation_Layer + *(__int32*)(*(unsigned __int32*)Proxy + 44)) = Value;

		*(void**)((unsigned __int32)Networked_Animation_Layers + (__int32)Animation_Layer + *(__int32*)(*(unsigned __int32*)Proxy + 44) - *(__int32*)((unsigned __int32)Animation_Layer->Owner + 9600)) = *(void**)((unsigned __int32)Proxy + 8);
	}
}