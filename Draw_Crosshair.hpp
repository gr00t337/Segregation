void Redirected_Draw_Crosshair()
{
	...
	Rotation_Angle = __builtin_remainderf(Rotation_Angle - (*(Global_Variables_Structure**)((unsigned __int32)Client_Module + 6854516))->Frame_Time * Interface_Uber_Alles_Speed.Get_Integer(), 180.f);
}